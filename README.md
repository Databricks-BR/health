...
| -- | -- | -- |
| 14:00  | Abertura do Congresso | Marcelo Sales |
...
| 15:20  | Monitoramento de Linhas de Cuidado	| Grupo Fleury |
| 15:40  | Diego Neufert | EMS |
| 16:00  | Coffee Break | Networking |
| 16:20  | Apresentação dos Projetos dos Parceiros | Dadoteca, DTI, Digiage, NCS |
| 17:00  | Mesa Redonda com empresas | Leve Saúde, Hosp Sirio Libanes |
| 17:40  | Encerramento	| Clecio Silva |
...
| <img src='https://github.com/Databricks-BR/health/raw/main/palestrantes/flavio_valiati.png' width='90px'></img> | **Clecio Silva**, Field Engineering Manager na DATABRICKS. Profissional com mais de 17 anos em dados e inteligência artificial, liderando equipes de arquitetura de soluções e vendas técnicas para Analytics em diversos segmentos, com sólida experiência em mercado brasileiro e LATAM. |
...
| <img src='https://github.com/Databricks-BR/health/raw/main/palestrantes/paulo_rebello.png' width='90px'></img> | **Diego Neufert**, CTO da EMS, empresa do Grupo NC, lidera a estratégia global de tecnologia e inovação. Com mais de 20 anos de experiência, ele é responsável por acelerar a transformação digital e promover soluções de saúde orientadas por dados em toda a organização. |
...
Todos os aceleradores podem ser executados diretamente em seu próprio workspace Databricks ou utilizando a [Free Edition](https://www.databricks.com/learn/free-edition).

| Acelerador | Link |
| -- | -- |
| FHIR Interoperabilidade com dbignite | https://www.databricks.com/solutions/accelerators/fhir |
| Pixels Medical Image Processing - DICOM | https://www.databricks.com/solutions/accelerators/pixels-medical-image-processing |
| HL7v2 Interoperabilidade com Smolder | https://www.databricks.com/solutions/accelerators/hl7v2 |
| Genome-Wide Association - VCF | https://www.databricks.com/solutions/accelerators/genome-wide-association-studies |
| Buscador de Medicamentos - Databricks App | LINK GITHUB |
| MEDGemma - Avaliação de Imagens Médicas | LINK GITHUB |
| Evo2 - NVIDIA | LINK GITHUB | 
